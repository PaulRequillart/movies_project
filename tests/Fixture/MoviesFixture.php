...
class MoviesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'duration' => ['type' => 'string', 'length' => 15, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'duration' => 'Lorem ipsum d',
                'country_id' => 1,
                'category_id' => 1,
                'image' => 'Lorem ipsum dolor sit amet',
                'created' => '2018-07-07 13:38:36',
                'modified' => '2018-07-07 13:38:36'
            ],
        ];
        parent::init();
    }
